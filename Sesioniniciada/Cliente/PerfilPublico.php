    ...
    <header class="p-3 text-bg-dark">
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <h1 class="main-header__title">ECHO</h1>

         
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <br></br>
              <li><a href="Home.html" class="nav-link px-2 text-white">Home</a></li>&nbsp;&nbsp;&nbsp;&nbsp;
              <li><a href="Perfil.html" class="nav-link px-2 text-secondary">Perfil</a></li>&nbsp;&nbsp;&nbsp;&nbsp;
              <li><a href="Tienda.html" class="nav-link px-2 text-white">Shop</a></li>&nbsp;&nbsp;&nbsp;&nbsp;
              <li><a href="Carrito.html" class="nav-link px-2 text-white"> <i class="fa-solid fa-cart-shopping"></i> &nbsp;&nbsp;Carrito </a></li>
            ...
            <ul class="nav col-12 col-lg-auto  mb-md-0">
                <li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark ">
                      ...
                      <li><a class="dropdown-item" href="TodosProductos.html">Mis Cursos</a></li>
                      <li><a class="dropdown-item" href="MisOrdenes.html">Mis Ordenes</a></li>
                      <li><a class="dropdown-item" href="Listas.html">Mis Categorias</a></li>
                      <li><a class="dropdown-item" href="Chat.html">Chat</a></li>
                      <li>
                        <a class="dropdown-item dropdown-item-danger d-flex gap-2 align-items-center" href="/Sesioniniciada/Instructor/Home.html">
    ...
    <section class="seccion-perfil-usuario">
        ...
        <div class="perfil-usuario-body">
            <div class="perfil-usuario-bio">
                <h3 class="titulo text-black">Maria Alejandra De la Cruz</h3>
